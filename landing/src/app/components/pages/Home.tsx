          ...
          <div className="content-area">
              ...
              <section className="project-case-study-wrapper techex-landing-page">
                      ...
                      <div className="row">
                          <div className="col-12">
                              <div className="section-title text-center">
                                  <a className="theme-btn-sm mb-15" data-aos="fade-up">Our Completed Projects</a>
                                  <h1 data-aos="fade-up" data-aos-delay="100">We Have Successfully Completed One IT
                                      Solutions Project</h1>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="success-item__wrapper owl-carousel owl-theme">
                      <a href="#" className="success-item">
                          <div className="thumb bg-cover"
                               style={{backgroundImage: "url('assets/img/techex-landing-page/success-item-1.jpg')" }} ></div>
                      ...
                      <a href="#" className="success-item">
                          <div className="thumb bg-cover"
                               style={{backgroundImage: "url('assets/img/techex-landing-page/success-item-2.jpg')" }} ></div>
                          <div className="content d-flex align-items-center justify-content-between">
                              <div className="text">
                      ...
                      <a href="#" className="success-item">
                          <div className="thumb bg-cover"
                               style={{backgroundImage: "url('assets/img/techex-landing-page/success-item-3.jpg')" }} ></div>
                          <div className="content d-flex align-items-center justify-content-between">
                              <div className="text">
                      ...
                      <a href="#" className="success-item">
                          <div className="thumb bg-cover"
                               style={{backgroundImage: "url('assets/img/techex-landing-page/success-item-4.jpg')" }} ></div>
                          <div className="content d-flex align-items-center justify-content-between">
                              <div className="text">
                  ...
                  <div className="container">
                      <div className="row align-items-center">
                          <div className="col-md-8">
                              <div className="section-title">
                                  <a className="theme-btn-sm mb-15" data-aos="fade-right">Client Testimonials</a>
                                  <h1 data-aos="fade-right" data-aos-delay="100">What They’re Talking</h1>
                              </div>
                              ...
                              <div className="testimonial-carousel-3 owl-carousel owl-theme">
                                  <div className="single-testimonial active">
                                      ...
                                      <h2>Techex has been around for more than adecade. It’s a trusted social media tool
                                          for businesses of all shapes and sizes.</h2>
                                      <div className="client-info">
                                          <div className="client-bio">
                                              <p><a href="#">Symash Petel,</a> CEO-Aliner</p>
                                          </div>
                                      </div>
                                  </div>
                          ...
                          <div className="col-md-4">
                              <div className="testimonial-media" data-aos="fade-left">
                                  <img src="/assets/img/techex-landing-page/testimonial-media.png" alt="" className="img-fluid" />
                              </div>
                          </div>
                      </div>
                  </div>
