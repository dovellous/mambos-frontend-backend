...
const Dashboard:React.FunctionComponent<PageProps> = ({ children, ...props}) : any | null => {
                                      ...
                                      <form action="javascript:void(0);">
                                          <div className="row g-3 mb-0 align-items-center">
                                              ...
                                              <div className="col-auto">
                                                  <button type="button" className="btn btn-soft-success shadow-none">
                                      ...
                                      <div className="d-flex align-items-end justify-content-between mt-4">
                                          <div>
                                              <h4 className="fs-22 fw-semibold ff-secondary mb-4">$<span
                                                  className="counter-value" data-target="559.25">0</span>k </h4>
                              ...
                              <div className="card card-animate">
                                  <div className="card-body">
                                      ...
                                      <div className="d-flex align-items-end justify-content-between mt-4">
                                          <div>
                                              <h4 className="fs-22 fw-semibold ff-secondary mb-4"><span
                                                  className="counter-value" data-target="183.35">0</span>M </h4>
                              ...
                              <div className="card card-animate">
                                  <div className="card-body">
                                      ...
                                      <div className="d-flex align-items-end justify-content-between mt-4">
                                          <div>
                                              <h4 className="fs-22 fw-semibold ff-secondary mb-4">$<span
                                                  className="counter-value" data-target="165.89">0</span>k </h4>
                              ...
                              <div className="card card-height-100">
                                  ...
                                  <div className="card-body">
                                      ...
                                      <div className="px-2 py-2 mt-1">
                                          ...
                                          <div className="progress bg-soft-primary mt-2" style="height: 6px;">
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div>
                                                              <h5 className="fs-14 my-1"><a
                                                                  href="apps-ecommerce-product-details.html"
                                                                  className="text-reset">Branded T-Shirts</a></h5>
                                              ...
                                              <tr>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div>
                                                              <h5 className="fs-14 my-1"><a
                                                                  href="apps-ecommerce-product-details.html"
                                                                  className="text-reset">Bentwood Chair</a></h5>
                                                  ...
                                                  <td>
                                                      <h5 className="fs-14 my-1 fw-normal"><span
                                                          className="badge badge-soft-danger">Out of stock</span>
                                                      </h5>
                                                      <span className="text-muted">Stock</span>
                                                  </td>
                                                  <td>
                                                  ...
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div>
                                                              <h5 className="fs-14 my-1"><a
                                                                  href="apps-ecommerce-product-details.html"
                                                                  className="text-reset">Borosil Paper Cup</a>
                                                              </h5>
                                                  ...
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div>
                                                              <h5 className="fs-14 my-1"><a
                                                                  href="apps-ecommerce-product-details.html"
                                                                  className="text-reset">One Seater Sofa</a></h5>
                                                  ...
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div>
                                                              <h5 className="fs-14 my-1"><a
                                                                  href="apps-ecommerce-product-details.html"
                                                                  className="text-reset">Stillbird Helmet</a></h5>
                                                          ...
                                                          <div>
                                                              <h5 className="fs-14 my-1 fw-medium">
                                                                  <a href="apps-ecommerce-seller-details.html"
                                                                     className="text-reset">iTest Factory</a>
                                                              </h5>
                                                      ...
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div className="flex-grow-1">
                                                              <h5 className="fs-14 my-1 fw-medium"><a
                                                                  ...
                                                                  className="text-reset">Digitech Galaxy</a></h5>
                                                  ...
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div className="flex-gow-1">
                                                              <h5 className="fs-14 my-1 fw-medium"><a
                                                                  href="apps-ecommerce-seller-details.html"
                                                                  className="text-reset">Nesta Technologies</a>
                                                              </h5>
                                                  ...
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div className="flex-grow-1">
                                                              <h5 className="fs-14 my-1 fw-medium"><a
                                                                  href="apps-ecommerce-seller-details.html"
                                                                  className="text-reset">Zoetic Fashion</a></h5>
                                                  ...
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          ...
                                                          <div className="flex-grow-1">
                                                              <h5 className="fs-14 my-1 fw-medium">
                                                                  <a href="apps-ecommerce-seller-details.html"
                                                                     className="text-reset">Meta4Systems</a>
                                                              </h5>
                                      ...
                                      <div className="table-responsive table-card">
                                          <table
                                              ...
                                              <tr>
                                                  <td>
                                                      <a href="apps-ecommerce-order-details.html"
                                                         className="fw-medium link-primary">#VZ2112</a>
                                                  </td>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          <div className="flex-shrink-0 me-2">
                                                  ...
                                                  <td>
                                                      <h5 className="fs-14 fw-medium mb-0">5.0<span
                                                          className="text-muted fs-11 ms-1">(61 votes)</span></h5>
                                                  </td>
                                              </tr>
                                              {/*    end tr    */}
                                              <tr>
                                                  <td>
                                                      <a href="apps-ecommerce-order-details.html"
                                                         className="fw-medium link-primary">#VZ2111</a>
                                                  </td>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          <div className="flex-shrink-0 me-2">
                                              ...
                                              <tr>
                                                  <td>
                                                      <a href="apps-ecommerce-order-details.html"
                                                         className="fw-medium link-primary">#VZ2109</a>
                                                  </td>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          <div className="flex-shrink-0 me-2">
                                                  ...
                                                  <td>
                                                      <h5 className="fs-14 fw-medium mb-0">4.9<span
                                                          className="text-muted fs-11 ms-1">(89 votes)</span></h5>
                                                  </td>
                                              </tr>
                                              {/*    end tr    */}
                                              <tr>
                                                  <td>
                                                      <a href="apps-ecommerce-order-details.html"
                                                         className="fw-medium link-primary">#VZ2108</a>
                                                  </td>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          <div className="flex-shrink-0 me-2">
                                                  ...
                                                  <td>
                                                      <h5 className="fs-14 fw-medium mb-0">4.3<span
                                                          className="text-muted fs-11 ms-1">(47 votes)</span></h5>
                                                  </td>
                                              </tr>
                                              {/*    end tr    */}
                                              <tr>
                                                  <td>
                                                      <a href="apps-ecommerce-order-details.html"
                                                         className="fw-medium link-primary">#VZ2107</a>
                                                  </td>
                                                  <td>
                                                      <div className="d-flex align-items-center">
                                                          <div className="flex-shrink-0 me-2">
                                                  ...
                                                  <td>
                                                      <h5 className="fs-14 fw-medium mb-0">4.7<span
                                                          className="text-muted fs-11 ms-1">(161 votes)</span>
                                                      </h5>
                                                  </td>
                                              </tr>
                                              {/*    end tr    */}
                          ...
                          <div className="card-body p-0">
                                  ...
                                  <div className="acitivity-timeline acitivity-main">
                                      <div className="acitivity-item d-flex">
                                          <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                              <div
                                                  className="avatar-title bg-soft-success text-success rounded-circle shadow">
                                      ...
                                      <div className="acitivity-item py-3 d-flex">
                                          <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                              <div
                                                  className="avatar-title bg-soft-danger text-danger rounded-circle shadow">
                                                  <i className="ri-stack-fill"></i>
                                              </div>
                                          </div>
                                          <div className="flex-grow-1 ms-3">
                                              <h6 className="mb-1 lh-base">Added new <span className="fw-semibold">style collection</span>
                                              </h6>
                                      ...
                                      <div className="acitivity-item py-3 d-flex">
                                          <div className="flex-shrink-0">
                                              <div className="avatar-xs acitivity-avatar">
                                                  <div
                                                      className="avatar-title rounded-circle bg-soft-danger text-danger shadow">
                                      ...
                                      <div className="acitivity-item py-3 d-flex">
                                          ...
                                          <div className="flex-grow-1 ms-3">
                                              ...
                                              <p className="text-muted mb-0">Flash sale by <a
                                                  href="javascript:void(0);" className="link-secondary fw-medium">Zoetic
                                                  Fashion</a></p>
                                      ...
                                      <div className="acitivity-item py-3 d-flex">
                                          <div className="flex-shrink-0">
                                              <div className="avatar-xs acitivity-avatar">
                                                  <div
                                                      className="avatar-title rounded-circle bg-soft-info text-info shadow">
                                          ...
                                          <div className="flex-grow-1 ms-3">
                                              ...
                                              <p className="text-muted mb-2"><span
                                                  className="text-danger">2 days left</span> notification to
                                      ...
                                      <div className="acitivity-item d-flex">
                                          ...
                                          <div className="flex-grow-1 ms-3">
                                              ...
                                              <p className="text-muted mb-2 fst-italic">" A product that has reviews
                              ...
                              <div className="p-3 mt-2">
                                  ...
                                  <div className="mt-3 text-center">
                                      <a href="javascript:void(0);" className="text-muted text-decoration-underline">View
                                          all Categories</a>
                                  </div>
                              </div>
                              <div className="p-3">
                              ...
                              <div className="p-3">
                                  ...
                                  <div className="text-center">
                                      <div className="text-muted">Total <span className="fw-medium">5.50k</span> reviews
                                      </div>
                                  </div>
                                  ...
                                  <div className="mt-3">
                                      <div className="row align-items-center g-2">
                                          ...
                                          <div className="col">
                                              <div className="p-1">
                                                  <div
                                                      className="progress bg-soft-success animated-progress progress-sm">
                                      ...
                                      <div className="row align-items-center g-2">
                                          ...
                                          <div className="col">
                                              <div className="p-1">
                                                  <div
                                                      className="progress bg-soft-warning animated-progress progress-sm">
                                      ...
                                      <div className="row align-items-center g-2">
                                          ...
                                          <div className="col">
                                              <div className="p-1">
                                                  <div
                                                      className="progress bg-soft-danger animated-progress progress-sm">
